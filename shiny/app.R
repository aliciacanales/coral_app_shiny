                ...
                navbarPage("Coral Across Northshore Moorea",
                           tabPanel('About',
                                    mainPanel(
                                      ...
                                      img(src='https://www.google.com/url?sa=i&url=https%3A%2F%2Fstock.adobe.com%2Fimages%2Fmacro-of-finger-coral-acropora-humilis-with-open-polyps-pacific-ocean-french-polynesia%2F131706003&psig=AOvVaw2tvb6jACQQS8sa-084O0pO&ust=1679106547710000&source=images&cd=vfe&ved=0CA8QjRxqFwoTCKjnmrz14f0CFQAAAAAdAAAAABAZ', height = "200px", width = "300px"),
                                    ...
                                    sidebarLayout(position = 'left',
                                     sidebarPanel(h4("Enter Values:"),
                                                  textInput(inputId = "site",
                                                            label = "Site Number"),
                                                  h6("Values should be between 0 and 150 mm"),
                           ...
                           plotOutput('bar'), 
                           h4('This bar plot presents the probability that an undetermined or new Moorea coral is pocillopora or acropora. The user input values are applied to a binomial logistic regression that we have trained using the rest of the coral data set. Based on those values we can predict the likelihood of if the unknown coral is species pocillopora or acropora.'),
                                    ),
